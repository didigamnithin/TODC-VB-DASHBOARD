...
if marketing_df is not None and financial_df is not None:
    ...
    with col1:
        ...
        orders_count = len(financial_filtered)
        
        # Calculate Net Total / Overall Subtotal percentage
        net_to_subtotal_ratio = (net_total / overall_subtotal * 100) if overall_subtotal > 0 else 0
        ...
        # Show Net/Subtotal Ratio prominently
        st.markdown(f"**📊 Net/Subtotal Ratio: {net_to_subtotal_ratio:.1f}%** *(You keep {net_to_subtotal_ratio:.1f}% of the subtotal)*")
